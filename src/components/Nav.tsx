...
import arrowbl from '../images/icon-arrow-dark.svg'
...
const Nav = () => {
    ...
    return (
        <nav>
            <div className="Nav">
                <div className='left-nav'>
                    ...
                    <ul className='navlink'>
                        <li className='link'><a href='#'>Product</a> <img src={arrow}></img></li>
                        <li className='link'><a href='#'>Company</a> <img src={arrow}></img></li>
                        <li className='link'><a href='#'>Contact</a> <img src={arrow}></img></li>
                    </ul>
                </div>
                <div className="mright-nav">
                    <img src={burger} alt="" id='burgerbtn'/>
            ...
            <div className="menu disable" id='menu'>
                <div className="menulist">
                    <ul className='mnavlink'>
                        <li className='mlink'><a href='#'>Product</a> <img src={arrowbl}></img></li>
                        <li className='mlink'><a href='#'>Company</a> <img src={arrowbl}></img></li>
                        <li className='mlink'><a href='#'>Contact</a> <img src={arrowbl}></img></li>
                    </ul>
